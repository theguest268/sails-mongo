...
module.exports = (function() {
  ...
  var adapter = {
    ...
    appendCollections: function(connection, collections, cb) {
      if(!connections[connection.identity] || !connections[connection.identity].connection.db) {
        this.registerConnection(connection, collections, cb);
        return;
      }
      
      const db = connections[connection.identity].connection;
    ...
    removeCollections: function(connection, collections) {
      const conn = connections[connection.identity];
